...
```{r, echo = F, fig.width=12, fig.height=4, out.width="100%", message=FALSE, dev="svg", warning=FALSE, message=FALSE}
ggplot(
  data_absence%>%
    gather(var, val) %>% 
    group_by(var) %>% 
...
---
### Übung 2: Elternzufriedenheit Homeschooling
```{r, echo = F, fig.width = 14, warnign = F, warning=FALSE, message=FALSE}
